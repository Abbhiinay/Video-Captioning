    ...
    >
      ...
      <div
        ...
        className={`upload-zone rounded-2xl p-12 flex flex-col items-center justify-center
                    text-center cursor-pointer transition-all duration-400 relative overflow-hidden
      ...
      >
        ...
        <AnimatePresence mode="wait">
          {selectedFile ? (
            ...
            >
              <motion.div
                className="w-16 h-16 rounded-2xl bg-secondary/10 border border-secondary/20 flex items-center justify-center"
                animate={{
                  boxShadow: [
              ...
              <div>
                <p className="text-on-surface font-semibold text-lg">{selectedFile.name}</p>
            ...
            >
              ...
              <div className="flex items-center gap-2 mt-2">
                {["MP4", "WebM", "MOV"].map((fmt) => (
                  <span
                    key={fmt}
                    className="px-3 py-1 rounded-lg text-xs font-medium bg-white/5 border border-white/8 text-on-surface-variant"
                  >
                    {fmt}
                  </span>
                ))}
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className={`magnetic-btn w-full mt-6 py-4 rounded-xl text-white font-semibold text-lg
